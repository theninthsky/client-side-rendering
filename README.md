...
<br>
There are countless other examples of how this delayed functionality severly hurts the UX. There are apps in which not even a single page can be staticly generated without causing a layout shift, others only show the navigation bar after JS has been loaded.
